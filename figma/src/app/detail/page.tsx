...
import { arr } from "../Product/Utils/Productdata"; // Import the product data
...
const Details = () => {
  ...
  const [quantity, setQuantity] = useState(1); // Moved here
    ...
    <div>
      ...
      <div className="flex flex-col md:flex-row md:space-x-8 md:px-10 px-4 py-6">
        ...
        <div className="md:w-1/2 w-full">
          ...
          <span className="text-xl block my-2">£{price}</span>
