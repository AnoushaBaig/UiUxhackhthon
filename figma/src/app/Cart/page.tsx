  ...
  return (
    <div className="min-h-[80vh] max-w-[1280px] m-auto p-3 py-20">
      ...
      <div className="w-full flex justify-between items-center py-12">
        <button className="xs:px-10 xs:py-3 px-6 py-2 border-[1px] font-medium xs:text-base text-sm rounded-sm border-zinc-500 bg-slate-500 text-nowrap">Return To Shop</button>
        <button className="xs:px-10 xs:py-3 px-6 py-2 border-[1px] font-medium xs:text-base text-sm rounded-sm border-zinc-500 bg-slate-600 text-nowrap">Go To Checkout</button>
      </div>
      ...
      <div className="w-full flex justify-between items-start py-10 sm:flex-row flex-col gap-4">
        <div className="flex items-center gap-2">
          ...
          <button className="sm:px-6 px-3 sm:py-3 py-[14px] bg-[#2A254B] rounded-sm text-white sm:text-sm text-xs">Apply Coupon</button>
        </div>
        ...
        <div className="border-2 border-zinc-600 sm:w-96 w-full p-6 rounded-md">
          ...
          <div className="w-full flex justify-center py-2">
            <button className="px-10 mt-2 py-3 bg-[#2A254B] rounded-sm text-white text-sm">Procees to checkout</button>
          </div>
        </div>
      </div>
    </div>
